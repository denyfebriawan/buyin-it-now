...
// product's stock in the same statement.
export async function addToCart(
  ...
  // Nothing changed, so the product is missing or has no stock. Only now do we
  // spend a second query to tell the two cases apart for the message.
